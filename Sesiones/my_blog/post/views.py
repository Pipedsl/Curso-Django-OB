...
def queries(request):
    ...
    #  filtered = Author.objects.filter(email='linda74@example.net')
    ...
    return render(request, 'post/queries.html', {'authors':authors, 'filtered':filtered, 'author':author, 'limits':limit, 'offsets':offsets, 'orders':orders,})
